...
var Wayfarers = /** @class */ (function (_super) {
    ...
    function Wayfarers() {
        ...
        _this.path1 = 'react-path-Wayfarers-1';
        _this.path2 = 'react-path-Wayfarers-2';
        _this.filter1 = 'react-filter-Wayfarers-1';
        _this.linearGradient1 = 'react-linear-gradient-Wayfarers-1';
        return _this;
    }
