...
var Sunglasses = /** @class */ (function (_super) {
    ...
    function Sunglasses() {
        ...
        _this.path1 = 'react-path-Sunglasses-1';
        _this.path2 = 'react-path-Sunglasses-2';
        _this.filter1 = 'react-filter-Sunglasses-1';
        _this.linearGradient1 = 'react-linear-gradient-Sunglasses-1';
        _this.linearGradient2 = 'react-linear-gradient-Sunglasses-2';
        return _this;
    }
